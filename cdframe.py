...
class MyFrame1(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(682, 456), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_button3 = wx.Button(self, wx.ID_ANY, u"暂停/恢复调度", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer1.Add(self.m_button3, 0, wx.ALL, 5)

        self.m_staticText1 = wx.StaticText(self, wx.ID_ANY, u"             时间片大小：", wx.Point(-1, -1), wx.Size(-1, -1),
                                           0)
        ...
        self.m_textCtrl3 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, 200),
                                       wx.TE_MULTILINE)
        fgSizer2.Add(self.m_textCtrl3, 0, wx.ALL, 5)

        self.m_textCtrl4 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, 200),
                                       wx.TE_MULTILINE)
        fgSizer2.Add(self.m_textCtrl4, 0, wx.ALL, 5)

        self.m_textCtrl5 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, 200),
                                       wx.TE_MULTILINE)
        fgSizer2.Add(self.m_textCtrl5, 0, wx.ALL, 5)

        self.m_textCtrl6 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, 200),
                                       wx.TE_MULTILINE)
        fgSizer2.Add(self.m_textCtrl6, 0, wx.ALL, 5)

        self.m_textCtrl7 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, 200),
                                       wx.TE_MULTILINE)
